...
export function Pets() {
    ...
    const urlParams = {
        ...
        type: searchParams.get('type') ?? '',  //se nao tiver especificado o parmetro type, queremos que na URL fique uma string vazia e não undefined
    ...
    function applyFilters(event: FormEvent) {
        event.preventDefault()                       //começa previnindo para não fazer reload de pagina
        ...
        <Grid>
            <div className={styles.container}>
                ...
                <form className={styles.filters} onSubmit={applyFilters} onChange={checkButtonStatus}>
                    ...
                    <Button
                        type="submit"
                        variant={isButtonEnabled ? ButtonVariants.Default : ButtonVariants.Disabled}
                    >Buscar</Button>
                </form>
